...
return (
  ...
  <div className="flex items-center gap-3">
    <img
      ...
      className="h-14 w-14 rounded-xl border border-white/10 bg-white/5 p-1"
    />
    <div className="flex flex-col">
      <h1 className="text-2xl font-black tracking-tight">Aontas — Kilgobnet N.S.</h1>
      <p className="text-slate-300 text-sm">Inclusive reading packs (Standard + Supported) for one class, two streams.</p>
      <p className="text-slate-400 text-xs">Paste text, fetch an article, or drop in a photo/screenshot of a page.</p>
    </div>
  </div>
</header>
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2 rounded-2xl border border-white/10 bg-white/5 p-3">
          ...
          <span className="ml-auto text-sm text-slate-300">{readingStatus || "Ready."}</span>
        </div>
        {/* Source */}
      ...
      <option key={s} value={String(s)}>
        {stageLabel(s)}
            ...
            <div className="rounded-2xl border border-white/10 bg-slate-900 p-4">
              ...
              <div className="mt-1 text-xs text-slate-400">Upload a photo/screenshot of a page and extract the text into the box below.</div>
              <div className="mt-3 flex flex-col gap-2">
                <input
                  type="file"
                  accept="image/*"
                  onChange={(e) => onPickImage(e.target.files?.[0])}
                  className="block w-full text-sm text-slate-200 file:mr-3 file:rounded-lg file:border-0 file:bg-white/10 file:px-3 file:py-2 file:font-semibold file:text-slate-100 hover:file:bg-white/15"
                />
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button
                    ...
                    className="rounded-xl border border-white/10 bg-white/10 px-4 py-2 font-semibold hover:bg-white/15 disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    Extract text
                  </button>
        ...
        <section className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4">
          <div className="flex flex-col gap-3">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-900 p-3">
                <div className="text-xs font-bold text-slate-300">SUPPORTED</div>
                <pre className="mt-2 whitespace-pre-wrap text-sm text-slate-100">
                  {SUPPORTEDReading || "—"}
                </pre>
              </div>
